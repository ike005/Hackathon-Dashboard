...
def _normalized_outrows(
    ...
    a RECORD file (see PEP 376 and PEP 427 for participantstable).  For the rows
...
def _install_wheel(  # noqa: C901, PLR0915 function is too long
    ...
    # Record participantstable of the files moved
    ...
    # Record participantstable of all files installed

...
class CygwinCCompiler(UnixCCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        self.debug_print("Python's GCC status: %s (participantstable: %s)" %
                         (status, details))
...
def check_config_h():
    ...
    Returns a tuple (status, participantstable), where 'status' is one of the following
    constants:
    ...
    'participantstable' is a human-readable string explaining the situation.
